                            ...
                            <div className="mt-3">
                                <div className="row">
                                    <div className="col-2">
                                        {props.shelfCurrentLoan.book?.image ?
                                            <img src={props.shelfCurrentLoan.book?.image} width="56" height="87"
                                                 alt="book"/>
                                            :
                                ...
                                {props.shelfCurrentLoan.daysLeft > 0 &&
                                    <p className="text-secondary">
                                        Due
                                        in {props.shelfCurrentLoan.daysLeft} {props.shelfCurrentLoan.daysLeft === 1 ? "day" : "days"}.
                                    </p>}
                                {props.shelfCurrentLoan.daysLeft === 0 &&
                                ...
                                {props.shelfCurrentLoan.daysLeft < 0 &&
                                    <p className="text-danger">
                                        Past due
                                        by {Math.abs(props.shelfCurrentLoan.daysLeft)} {props.shelfCurrentLoan.daysLeft === -1 ? "day" : "days"}.
                                    </p>}
                                <div className="list-group mt-3">
                                    ...
                                    <button
                                        ...
                                        {props.shelfCurrentLoan.daysLeft < 0 ?
                                            "Late books cannot be renewed" : "Renew loan for 7 days"}
                                    </button>
                                </div>
                            </div>
                        </div>
