                ...
                <div className="card-body">
                    <form method="POST">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                <label htmlFor="dropdownMenuButton1" className="form-label">
                                    Category
                                </label>
                                ...
                                <ul id="addNewBookId" className="dropdown-menu"
                                    ...
                                    <li><a onClick={() => categoryField("FE")}
                                           className="dropdown-item">Front End</a></li>
                                    <li><a onClick={() => categoryField("BE")}
                                           className="dropdown-item">Back End</a></li>
                                    <li><a onClick={() => categoryField("Data")}
                                           className="dropdown-item">Data</a></li>
                                    <li><a onClick={() => categoryField("DevOps")}
                                           className="dropdown-item">DevOps</a></li>
                                </ul>
                            </div>
